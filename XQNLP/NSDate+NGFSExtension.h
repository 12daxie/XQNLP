...
///增加dHours小时
- (NSDate *)ng_fs_dateByAddingHours:(NSInteger)dHours;
///减少dHours小时
- (NSDate *)ng_fs_dateBySubtractingHours:(NSInteger)dHours;
///增加dMinutes分钟
- (NSDate *)ng_fs_dateByAddingMinutes:(NSInteger)dMinutes;
///减少dMinutes分钟
- (NSDate *)ng_fs_dateBySubtractingMinutes:(NSInteger)dMinutes;
//
